...
export const NewsSection = () => {
  return <Card className="backdrop-blur-sm border border-white/20 bg-neutral-950 hover:bg-neutral-800">
      <CardHeader>
        <h3 className="text-xl font-bold text-white">آخر الأخبار المالية</h3>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          {news.map(item => <div key={item.id} className="p-4 rounded-lg hover:bg-white/5 transition-colors border border-white/10">
